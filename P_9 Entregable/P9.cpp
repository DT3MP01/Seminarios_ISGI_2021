...
// Coordenadas de la c�mara
float pos_cam[3] = { 0, 1.1, 0 };
float ant_pos = pos_cam[0];
int max_vision = 90;

// Velocidad y direcci�n del vehiculo
float velocidad = 0;
float angulo = 0;
float giro = 0;
...
{
	// Soluciona error de precisi�n de variables de coma flotante
	if (velocidad <= 0) {
		velocidad = 0;
	}

	// Actualizar posici�n camara
	static int antes = 0;
