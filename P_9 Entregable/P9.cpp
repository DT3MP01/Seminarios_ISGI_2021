...
void gen_circuito() {
	...
	for (int i = pos_cam[1] + ant_pos - 1; i < pos_cam[0] + numero_quads * longitud; i += longitud) {
		...
		v2[0] = { (float)i - vector_n[0] * (anchura/2) };
		v2[2] = { f_x - vector_n[1] * (anchura / 2) };

		v3[0] = { (float)i + vector_n[0] * (anchura / 2) };
		v3[2] = { f_x + vector_n[1] * (anchura / 2) };
		...
		v0[0] = { (float)i + longitud + vector_n[0] * (anchura / 2) };
		v0[2] = { f_x + vector_n[1] * (anchura / 2) };

		v1[0] = { (float)i + longitud - vector_n[0] * (anchura / 2) };
...
void gen_cartel() {
	...
	vector_n[0] = vector_n[0] / aux;
	vector_n[1] = vector_n[1] / aux;
	float v1[3] = { pos_cartel_x,4.5,f_x + (anchura / 2) };
	float v2[3] = { pos_cartel_x,4.5,f_x - (anchura / 2) };
	float v3[3] = { pos_cartel_x,2.5,f_x - (anchura / 2) };
	float v4[3] = { pos_cartel_x,2.5,f_x + (anchura / 2) };
	...
	// Poste derecho
	float v12[3] = { pos_cartel_x + 0.1,4.5,f_x + (anchura / 2) };
	float v22[3] = { pos_cartel_x + 0.1,4.5,f_x + (anchura / 2) + 1 };
	float v32[3] = { pos_cartel_x + 0.1,0,f_x + (anchura / 2) + 1 };
	float v42[3] = { pos_cartel_x + 0.1,0,f_x + (anchura / 2) };
	...
	// Poste izquierdo
	float v13[3] = { pos_cartel_x + 0.1,4.5,f_x - (anchura / 2) };
	float v23[3] = { pos_cartel_x + 0.1,4.5,f_x - (anchura / 2) - 1 };
	float v33[3] = { pos_cartel_x + 0.1,0,f_x - (anchura / 2) - 1 };
	float v43[3] = { pos_cartel_x + 0.1,0,f_x - (anchura / 2) };
...
void gen_farolas() {
	...
	for (int i = 0; i < 4; i++) {
		...
		vector_n[0] = vector_n[0] / aux;
		vector_n[1] = vector_n[1] / aux;
		GLfloat pos[] = { inicio_farolas[i], 4.0, f_x + vector_n[1] * (anchura / 2) - (anchura / 2), 1 };
...
void control_luces() {
	...
	//GLfloat posicion7[] = { -0.3,0.7,-0.5,1 };
	//GLfloat direccion7[] = { 0,-0.2,-0.7 };
